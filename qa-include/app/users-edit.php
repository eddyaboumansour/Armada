...
{	
	...
	//echo $userid. " / " .$userinfo['email'] . " / " .$userinfo['handle'] . " / " .$emailcode." / ". qa_lang('emails/confirm_subject') . " / " .qa_lang('emails/confirm_body') . " /||||||||||||| ".qa_get_new_confirm_url($userid, $userinfo['handle'], $emailcode)  ;
